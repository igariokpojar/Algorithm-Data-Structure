...
public class SunsetViews {
    ...
    public static ArrayList<Integer> sunsetViews(int[] buildings, String direction) {
        Stack<Integer> stack = new Stack<>(); // stack to hold buildings indicates that can see sunset
        // this part is for East default
        int i=0;
        int step=1;
        ...
        // now we have a stack with the buildings that can see the sunset
...
/*
 Given an array of buildings and a direction that all the buildings face, return
an array of the indices of the buildings that can see the sunset. A building can see
the sunset if it's strictly taller than all the buildings that come after it in the
direction that it faces. The input array named buildings contains positive, nonzero integers representing the heights of the buildings. A building at index i thus
has a height denoted by buildings[i] . All the buildings face the same direction,
